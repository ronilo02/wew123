                ...
                <div class="ibox-content">
                    <div class="file-manager">                     
                        ...
                        <ul class="folder-list" style="padding: 0">
                                <li ><a href="<?php echo e(url('/files')); ?>" ><i class="fa fa-folder" ></i> Agreement Form</a></li>
                                <li><a href="<?php echo e(url('/files/proposals')); ?>" style="color:#1ab394"><i class="fa fa-folder" style="color:#1ab394"></i> Proposals</a></li>
