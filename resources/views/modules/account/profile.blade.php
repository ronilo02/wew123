            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="{{ asset('images/user/'.auth()->user()->avatar) }}">
                    </div>
                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="#" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('images/user/'.auth()->user()->avatar) }}">
                                </a>
                            ...
                            <div class="feed-element">
                                ...
                                <div class="media-body ">
                                    ...
                                    <div class="photos">
                                        <a target="_blank" href="#"> <img alt="image" class="feed-photo" src="{{ asset('images/user/'.auth()->user()->avatar) }}"></a>
                                        <a target="_blank" href="#"> <img alt="image" class="feed-photo" src="{{ asset('img/p3.jpg') }}"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="feed-element">
