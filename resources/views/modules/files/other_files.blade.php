                ...
                <div class="ibox-content">
                    <div class="file-manager">                     
                        ...
                        <ul class="folder-list" style="padding: 0">
                                <li ><a href="{{ url('/files') }}" ><i class="fa fa-folder" ></i> Agreement Form</a></li>
                                <li><a href="{{ url('/files/proposals') }}" ><i class="fa fa-folder" ></i> Proposals</a></li>
                                <li><a href="{{ url('/files/other-files') }}" style="color:#1ab394"><i class="fa fa-folder" style="color:#1ab394"></i> Other Files</a></li>
