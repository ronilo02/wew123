                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r">
                                <h3 class="m-t-none m-b" style="color:#1ab394"><i class="fa fa-info-circle" style="color:#1ab394"></i> Author Information</h3>
                                    ...
                                    <div class="form-group"><label>Primary Email</label> <input type="email" name="email" value="@if(isset($lead)) {{ $lead->email }}  @endif" placeholder="Enter Primary Email" class="form-control" ></div>
                            </div>
